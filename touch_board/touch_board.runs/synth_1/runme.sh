...
HD_PWD='C:/Users/thb20/Desktop/Big_homework/touch_board/touch_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LinearFitting.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LinearFitting.tcl
